...
selectionSortf() 
{
  ...
  render() {
    ...
    const color = "rgba(214, 29, 29, 0.8)";
    ...
    return (
      <div className="array-container">
        {array.map((value, idx) => (
          ...
          />
          <label htmlFor="Size">Change Size of Array:</label>
          <input
          id="changeSize"
          type="range"
          name="Size"
          ...
          <button onClick={() => this.mergeSortf()}>Merge Sort</button>
          <button onClick={() => this.selectionSortf()}>Selection Sort</button>
          <button onClick={() => this.quickSortf()}>Quick Sort</button>
          <button onClick={() => this.heapSortf()}>Heap Sort</button>
          <button onClick={() => this.bubbleSortf()}>Bubble Sort</button>
          <button onClick={() => this.insertionSortf()}>Insertion Sort</button>
